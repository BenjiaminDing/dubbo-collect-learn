...
//        System.out.println(protocol);
        ...
        ExtensionLoader<com.tuling.Car> extensionLoader = ExtensionLoader.getExtensionLoader(com.tuling.Car.class);

        com.tuling.Car car = extensionLoader.getExtension("red"); // 自动注入，AOP
